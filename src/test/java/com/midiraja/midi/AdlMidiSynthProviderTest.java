...
class AdlMidiSynthProviderTest {
    ...
    static class MockAdlBridge implements AdlMidiNativeBridge {
        ...
        @Override public void setBank(int bankNumber) { bankSet = bankNumber; }
    ...
    void testPrepareForNewTrack() throws Exception {
        ...
        // Queue should be cleared before panic events (bridge.panic() called from render-paused context)
