...
class FluidSynthProviderTest {
    ...
    void testMidiMessageParsingAndRouting() throws Exception {
        ...
        // SysEx
        provider.sendMessage(new byte[]{(byte) 0xF0, 0x41, 0x10, 0x42, 0x12, 0x40, 0x00, 0x7F, 0x00, 0x41, (byte) 0xF7});
        ...
        // Note On w/ vel=0 is tricky. Some engines route it to NOTE_ON and let the engine handle vel 0, 
        // others explicitly call NOTE_OFF. For our binding, we map it directly as NoteOn.
