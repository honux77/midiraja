...
class PlaybackEngineTest
{
    ...
    {
        PlaybackEngine engine = new PlaybackEngine(mockSequence, mockProvider, new PlaylistContext(java.util.List.of(new java.io.File("test.mid")), 0, new com.midiraja.midi.MidiPort(0, "Mock"), null), 100, 1.0, java.util.Optional.empty(), java.util.Optional.empty());
