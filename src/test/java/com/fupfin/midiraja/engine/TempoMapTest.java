...
class TempoMapTest
{
    ...
    @Test
    void parseSeconds_returnsCorrectMicroseconds() throws Exception
    {
        assertEquals(30_000_000L, TempoMap.parseTimeToMicroseconds("30"));
    }

    @Test
    void parseMinutesAndSeconds_returnsCorrectMicroseconds() throws Exception
    {
        assertEquals(90_000_000L, TempoMap.parseTimeToMicroseconds("1:30"));
    }

    @Test
    void parseHoursMinutesSeconds_returnsCorrectMicroseconds() throws Exception
    {
        assertEquals(3_600_000_000L, TempoMap.parseTimeToMicroseconds("1:00:00"));
    }

    @Test
    void parseZero_returnsZero() throws Exception
    {
        assertEquals(0L, TempoMap.parseTimeToMicroseconds("0"));
    }

    @Test
    void parseBlankString_returnsZero() throws Exception
    {
        assertEquals(0L, TempoMap.parseTimeToMicroseconds("   "));
    }

    @Test
    void parseNonNumeric_returnsZero() throws Exception
    {
        assertEquals(0L, TempoMap.parseTimeToMicroseconds("abc"));
    }

    @Test
    void parseWithLeadingTrailingWhitespace_ignored() throws Exception
    {
        assertEquals(30_000_000L, TempoMap.parseTimeToMicroseconds("  30  "));
    }
    ...
    @Test
    void getTickForTime_negativeTarget_returnsMinusOne() throws Exception
    {
        assertEquals(-1L, TempoMap.getTickForTime(List.of(), 480, 1000L, -1L));
    }

    @Test
    void getTickForTime_zeroTarget_returnsMinusOne() throws Exception
    {
        assertEquals(-1L, TempoMap.getTickForTime(List.of(), 480, 1000L, 0L));
    }

    @Test
    void getTickForTime_constantBpm_tickProportionalToTime() throws Exception
    {
    ...
    @Test
    void getTickForTime_beyondSequence_returnsTickLength() throws Exception
    {
        int resolution = 480;
    ...
    @Test
    void getTickForTime_tempoChangeAffectsTickCalculation() throws Exception
    {
