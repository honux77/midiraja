...
public class AlsaProvider implements MidiOutProvider
{
    ...
    private static final MethodHandle snd_seq_close =
        getMH("snd_seq_close", FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));
    @Nullable
    ...
    private static final MethodHandle snd_seq_port_info_malloc = getMH("snd_seq_port_info_malloc",
        FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));
    @Nullable
    private static final MethodHandle snd_seq_port_info_free = getMH(
        "snd_seq_port_info_free", FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));
    @Nullable
    ...
    @Nullable
    private static final MethodHandle snd_midi_event_free = getMH(
        "snd_midi_event_free", FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));
    @Nullable
    ...
    // Drain output
    @Nullable
    private static final MethodHandle snd_seq_drain_output = getMH(
        "snd_seq_drain_output", FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));
    ...
    public void sendMessage(byte[] data) throws Exception
    {
        ...
        try
        {
            ...
            long processed =
                (long) snd_midi_event_encode.invokeExact(parser, dataSeg, (long) data.length, ev);
    ...
    @Override @SuppressWarnings({"NullAway", "UnusedVariable"}) public void closePort()
    {
        try
        {
