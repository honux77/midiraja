...
import com.midiraja.midi.timidity.JavaTimiditySynthProvider;
import java.io.File;
...
@Command(name = "timidity",
         description =
             "Play using Pure Java TiMidity (Gravis Ultrasound patches)")
public class TimidityCommand implements Callable<Integer> {
  @ParentCommand
  ...
  public Integer call() throws Exception {
    ...
    var provider = new JavaTimiditySynthProvider(audio, dirPath);
