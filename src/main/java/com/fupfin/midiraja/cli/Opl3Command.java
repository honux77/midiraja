 ...
 *
 * <p>Uses 18 two-operator FM channels: 14 melodic + 4 percussion (round-robin).
 * All 128 General MIDI programs are mapped to built-in OPL3 patches.
 *
 * <p>Example:
 * <pre>
 *   midra opl3vgm song.mid              # writes song.vgm
 *   midra opl3vgm song.mid output.vgm  # writes output.vgm
 * </pre>
 */
@Command(name = "opl3vgm", mixinStandardHelpOptions = true,
        description = "Convert a MIDI file to VGM format (YMF262 OPL3, 18 FM channels, offline, no audio).")
public class Opl3Command implements Callable<Integer>
{
    @ParentCommand
    @Nullable
    ...
    public Integer call() throws Exception
    {
        ...
        try
        {
            MidiToOpl3Converter.convert(input, outputPath, err);
        }
        catch (Exception e)
        {
