...
import com.fupfin.midiraja.midi.vgm.MidiToVgmConverter;
import java.io.File;
...
/**
 * {@code midra vgm} — converts a MIDI file to a VGM file (SN76489 PSG chip).
 *
 ...
 * <p>Example:
 * <pre>
 *   midra vgm song.mid              # writes song.vgm
 *   midra vgm song.mid output.vgm  # writes output.vgm
 * </pre>
 */
@Command(name = "vgm", mixinStandardHelpOptions = true,
        description = "Convert a MIDI file to VGM format (SN76489 PSG chip, offline, no audio).")
public class VgmCommand implements Callable<Integer>
{
    ...
    public Integer call() throws Exception
    {
        ...
        try
        {
            MidiToVgmConverter.convert(input, outputPath, err);
        }
        catch (Exception e)
        {
    ...
    private String resolveOutputPath()
    {
        ...
        return parent != null ? new File(parent, vgmName).getPath() : vgmName;
    }
}
