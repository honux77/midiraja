...
public class BeepSynthProvider implements SoftSynthProvider
{
     ...
     */
    public BeepSynthProvider(com.fupfin.midiraja.dsp.@org.jspecify.annotations.Nullable AudioProcessor audioOut, int voices, double fmRatio, double fmIndex, int oversample, String muxMode, String synthMode)
    {
