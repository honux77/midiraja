...
public class PsgSynthProvider implements SoftSynthProvider
{
    ...
    public PsgSynthProvider(com.fupfin.midiraja.dsp.@org.jspecify.annotations.Nullable AudioProcessor audioOut, int systems, double vibratoDepth, double dutySweep, boolean useScc, boolean smoothScc)
    {
