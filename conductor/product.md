...
- **Embedded Soft Synth (FluidSynth):** Includes native FFM bindings for `libfluidsynth`, allowing zero-latency software synthesis directly within the CLI process. Simply provide a `.sf2` SoundFont via `--fluid`.
